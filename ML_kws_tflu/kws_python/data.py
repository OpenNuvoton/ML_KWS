...
class AudioProcessor:
    ...
    def __init__(self,data_exist, data_url, data_dir, silence_percentage, unknown_percentage,
        ...
        self._download_and_extract_data(data_exist, data_url, data_dir)
    ...
    def _download_and_extract_data(self,data_exist, data_url, target_directory):
        ...
        if data_exist:
            ...
            if (True): ##always download, prevent downloading non-completed.
